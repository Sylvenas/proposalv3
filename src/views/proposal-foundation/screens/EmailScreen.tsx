import { odaProjectInfo } from "@/data/odaMockDataFoundation";
                ...
                <div className="bg-white flex items-center justify-between flex-shrink-0 pb-[13px] pl-[12px] pr-[22px] pt-[15px]">
                  <div className="flex gap-[11px] items-end">
                    ...
                    <div className="flex flex-col gap-[7px] text-[#424242] whitespace-nowrap">
                      <p className="text-[16px] leading-[16px]">{`Bosterra, Inc. <tim@bosterra.com>`}</p>
                  ...
                  >
                    <div className="flex flex-col" style={{ width: 720 }}>
                      ...
                      <div className="bg-white flex flex-col gap-[27px] items-center pb-[64px] pt-[48px] px-[54px]">
                        ...
                        >
                          <p className="mb-[6px]">
                            Your foundation repair proposal from Bosterra, Inc.
                            is ready.
                          </p>
                          <p>
                            You can now review your project online — compare
                            foundation repair options, review included materials
                            and project scope, explore available financing, and
                        ...
                        >
                          ...
                          <ul className="text-[12px] leading-[20px] list-disc pl-5">
                            <li>Compare available foundation repair options</li>
                            <li>
                              Review included materials, repair scope, and
                              project details
                            </li>
                        ...
                        {/* CTA */}
                        <div
                          className="bg-[#2B4C7E] flex items-center justify-center px-[16px] py-[6px] rounded-[2px] flex-shrink-0"
                          style={{ height: 40 }}
                        >
                          <button
                            onClick={() =>
                              window.open(
                                "/proposal-foundation?screen=landing",
                                "_blank",
                              )
                            }
                        ...
                        >
                          ...
                          representative Tim Rice directly before making
                          your final decision.
                        </p>
                        <div
                          className="min-w-full text-[12px] text-[rgba(0,0,0,0.85)] leading-[20px]"
                      ...
                      >
                        ...
                        >
                          Bosterra, Inc.
                          <br />
                          1 Main St, Boston, MA 02135
                          <br />
                          617-867-5309 | tim@bosterra.com
                          <br />
                          License #CSLB 10988263
                        </p>
                        <p
                        ...
                        >
                          You are receiving this email because Bosterra, Inc.
