...
import { odaOptions, type ODAItem } from "@/data/odaMockDataFoundation";
...
export function OptionsScreen({
  ...
  const optionSummaries: OptionSummary[] = [
    {
      ...
      description:
        "Lifetime Transferable Service Warranty / Foundation Pilings",
      duration: "2–3 Days Estimated Time Under Construction",
      price: "$12,500.00 USD",
      contractTotal: "$12,500.00",
      monthly: "$150.00 / mo",
    ...
    },
    {
      ...
      description:
        "Poly-3 Soil Injection / Soil Stabilization",
      duration: "1 Day Estimated Time Under Construction",
      price: "$12,500.00 USD",
      contractTotal: "$12,500.00",
      monthly: "$150.00 / mo",
  ...
  const scheduleData: Array<Array<{ label: string; value: string }>> = [
    ...
    [
      ...
      { label: "Estimated Time Under Construction", value: "1 Day" },
      { label: "Proposal Valid Until", value: "April 30, 2026" },
    ],
  ];
