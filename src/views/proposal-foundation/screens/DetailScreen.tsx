...
import type { ODAItem, ODAOption } from "@/data/odaMockDataFoundation";

import { ODALogo } from "../components/ODALogo";
import { ProductDetailModal } from "../components/ProductDetailModal";
import { SignModal } from "../components/SignModal";
import { SummaryGroup } from "../components/SummaryGroup";
import { FOUNDATION_DRAWING_MAP, FOUNDATION_THUMB_PIER, FOUNDATION_THUMB_INJECTION, type SummaryLineItem, FOUNDATION_WARRANTY_IMG, sv } from "../shared";
...
export function DetailScreen({
  ...
  // Fixed product sections for foundation repair
  const mkItem = (id: string, name: string, price: number, img: string): ODAItem => ({
    id, name, spec: "", price, previewImage: img,
  });
  const foundationItems: SummaryLineItem[] = [
    { name: "Cable Lock™ ST Plus Piers", qty: "1", unit: "job", price: 10900, thumbnailSrc: FOUNDATION_THUMB_PIER, showChange: false, odaItem: mkItem("fp-1", "Cable Lock™ ST Plus Piers", 10900, FOUNDATION_THUMB_PIER) },
  ];
  const upgradeItems: SummaryLineItem[] = [
    { name: "Additional Support / Angle Iron", qty: "1", unit: "ea", price: 400, thumbnailSrc: FOUNDATION_THUMB_INJECTION, showChange: false, odaItem: mkItem("u-1", "Additional Support / Angle Iron", 400, FOUNDATION_THUMB_INJECTION) },
    { name: "Tunneling (5 ft)", qty: "1", unit: "ea", price: 1125, thumbnailSrc: FOUNDATION_THUMB_INJECTION, showChange: false, odaItem: mkItem("u-2", "Tunneling (5 ft)", 1125, FOUNDATION_THUMB_INJECTION) },
    { name: "Generator Rental", qty: "1", unit: "ea", price: 75, thumbnailSrc: FOUNDATION_THUMB_INJECTION, showChange: false, odaItem: mkItem("u-3", "Generator Rental", 75, FOUNDATION_THUMB_INJECTION) },
  ];
      ...
      >
        ...
        >
          ...
          >
            ...
            <SummaryGroup name="Foundation Repair" items={foundationItems} onInfoClick={handleProductInfoClick} />
            <SummaryGroup name="Upgrades" items={upgradeItems} onInfoClick={handleProductInfoClick} />
          </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <Image
                    src={FOUNDATION_DRAWING_MAP}
                    alt="Foundation Drawing"
                    fill
          ...
          >
            ...
            <div className="flex flex-col" style={{ gap: sv(24), fontWeight: 300, lineHeight: 1.5 }}>
              {[
                {
                  quote: `"We've owned our 1920s brownstone in Southie for 15 years and always had minor settling issues we ignored. When our front steps started pulling away from the house, we called three companies for estimates. Bosterra was the only one that actually took the time to walk us through the problem instead of just quoting a number. The foundation pier work they did was impeccable — you can barely tell anything was touched. Professional from the first phone call to the final inspection."`,
                  author: "— James R., South Boston, MA",
                },
                {
                  quote: `"We noticed cracks forming in our basement walls last spring and honestly panicked. Bosterra came out within two days, gave us a clear explanation of what was happening, and laid out a plan that made sense. The crew showed up on time every single day, kept the work area clean, and finished ahead of schedule. After a full New England winter with heavy rain and snowmelt, our basement is bone dry. Couldn't recommend them more highly."`,
                  author: "— Michael & Sarah T., Dorchester, MA",
                },
                {
                  quote: `"After getting water in our finished basement twice in one month, we were ready to just sell the house and move. A neighbor recommended Bosterra and I'm so glad they did. They diagnosed a foundation crack we didn't even know was there, repaired it, and installed an interior drainage system all in under four days. The pricing was straightforward with no surprise add-ons. That was a year ago and we haven't had a single drop of water since. These guys know what they're doing."`,
                  author: "— Karen L., Newton, MA",
                },
              ].map((r, i) => (
        ...
        >
          ...
          <div className="flex flex-col" style={{ gap: sv(4) }}>
            <div className="flex flex-col text-[#262626]">
              ...
              <p style={{ fontSize: sv(14) }}>Foundation Stabilization - Thompson Residence</p>
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            <div className="relative flex-1 overflow-hidden" style={{ borderRadius: sv(8) }}>
              ...
              >
                <Image src={FOUNDATION_DRAWING_MAP} alt="Foundation Drawing" fill className="object-contain" sizes="1104px" />
              </div>
