...
import { CONTRACT_PAGES, FOUNDATION_DRAWING_MAP, FOUNDATION_THUMB_PIER, FOUNDATION_THUMB_INJECTION, type SummaryLineItem, FOUNDATION_WARRANTY_IMG, sv } from "../shared";
...
export function ApprovedScreen({
  ...
  const foundationItems: SummaryLineItem[] = [
    { name: "Cable Lock™ ST Plus Piers", qty: "1", unit: "job", price: 10900, thumbnailSrc: FOUNDATION_THUMB_PIER, showChange: false, odaItem: mkItem2("fp-1", "Cable Lock™ ST Plus Piers", 10900, FOUNDATION_THUMB_PIER) },
  ];
  const upgradeItems: SummaryLineItem[] = [
    { name: "Additional Support / Angle Iron", qty: "1", unit: "ea", price: 400, thumbnailSrc: FOUNDATION_THUMB_INJECTION, showChange: false, odaItem: mkItem2("u-1", "Additional Support / Angle Iron", 400, FOUNDATION_THUMB_INJECTION) },
    { name: "Tunneling (5 ft)", qty: "1", unit: "ea", price: 1125, thumbnailSrc: FOUNDATION_THUMB_INJECTION, showChange: false, odaItem: mkItem2("u-2", "Tunneling (5 ft)", 1125, FOUNDATION_THUMB_INJECTION) },
    { name: "Generator Rental", qty: "1", unit: "ea", price: 75, thumbnailSrc: FOUNDATION_THUMB_INJECTION, showChange: false, odaItem: mkItem2("u-3", "Generator Rental", 75, FOUNDATION_THUMB_INJECTION) },
  ];
          ...
          {activeTab === "Contract" ? (
            ...
            <>
              ...
              >
                ...
                <SummaryGroup name="Foundation Repair" items={foundationItems} onInfoClick={handleApprovedProductInfoClick} />
                <SummaryGroup name="Upgrades" items={upgradeItems} onInfoClick={handleApprovedProductInfoClick} />
              </div>
              ...
              {/* Foundation Warranty — full-bleed image card */}
              <div
              ...
              >
                <Image
                  src={FOUNDATION_WARRANTY_IMG}
                  alt="Foundation Warranty"
                  fill
        ...
        {activeTab !== "Contract" ? (
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col w-full" style={{ gap: sv(4) }}>
                ...
                <div className="flex flex-col items-start w-full">
                  ...
                  >
                    <span className="text-[#262626]">$6,250 / </span>
                    <span className="text-[#737373]">$12,500</span>
                  </p>
                  {/* Progress bar */}
                  <div
            ...
            <div className="flex flex-col w-full" style={{ gap: sv(12) }}>
              {/* Make A Payment */}
              <button
                className="w-full bg-[#2B4C7E] text-white font-semibold flex items-center justify-center hover:opacity-80 transition-opacity"
