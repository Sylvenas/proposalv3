...
import { CONTRACT_PDF, sv } from "../shared";
      ...
      >
        ...
        <div className="flex-1 min-w-0 flex flex-col relative min-h-0">
          <div className="flex-1 overflow-auto border border-[#d9d9d9] min-h-0">
            <iframe
              src={`${CONTRACT_PDF}#toolbar=0`}
              className="w-full h-full bg-white"
              style={{ minWidth: "100%", minHeight: "100%", transform: `scale(${zoom})`, transformOrigin: "top left", border: "none" }}
            />
          </div>
