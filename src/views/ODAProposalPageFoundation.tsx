...
import { odaOptions } from "@/data/odaMockDataFoundation";

import { VALID_SCREENS, type Screen } from "./proposal-foundation/shared";
import { ApprovedScreen } from "./proposal-foundation/screens/ApprovedScreen";
import { DetailScreen } from "./proposal-foundation/screens/DetailScreen";
import { EmailScreen } from "./proposal-foundation/screens/EmailScreen";
import { LandingScreen } from "./proposal-foundation/screens/LandingScreen";
import { OptionsScreen } from "./proposal-foundation/screens/OptionsScreen";

export default function ODAProposalPageFoundation({
  initialScreen = "email",
}: {
